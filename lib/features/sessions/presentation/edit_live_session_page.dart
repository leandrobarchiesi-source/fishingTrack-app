...
class EditLiveSessionPage extends StatefulWidget {
  ...
  @override
  State<EditLiveSessionPage> createState() =>
      _EditLiveSessionPageState();
}

class _EditLiveSessionPageState
    extends State<EditLiveSessionPage> {
  final temperaturaAcquaController =
      TextEditingController();

  final noteController =
      TextEditingController();

  final counterControllers =
...
print(
  "Counter ${entry.key} = '${entry.value.text}'",
    ...
    final counterNameId =
        await widget.database.getOrCreateCounterName(
      name,
...
Future<void> loadData() async {
  final usedNames =
      await widget.database.getUsedCounterNames();
  ...
  final maxCounter =
      await widget.database.getMaxCounterNumber(
    widget.session.id,
  );
