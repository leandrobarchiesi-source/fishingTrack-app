...
class T {
  ...
  static String get sessionLog => _tr(
        it: 'Session Log',
        en: 'Session Log',
        fr: 'Journal de session',
        es: 'Registro de sesión',
      );

  static String get noEventsRecorded => _tr(
        it: 'Nessun evento registrato',
        en: 'No events recorded',
        fr: 'Aucun événement enregistré',
        es: 'Ningún evento registrado',
      );

  static String get counters => _tr(
        it: 'Contatori',
        en: 'Counters',
        fr: 'Compteurs',
        es: 'Contadores',
  ...
  static String get temperature => _tr(
        it: 'Temperatura',
        en: 'Temperature',
        fr: 'Température',
        es: 'Temperatura',
  ...
  static String get sessionStarted => _tr(
        it: 'Sessione iniziata',
        en: 'Session started',
        fr: 'Session démarrée',
        es: 'Sesión iniciada',
      );

  static String get sessionEnded => _tr(
  ...
  static String catchCounter(int counter) => _tr(
        it: 'Cattura - Contatore $counter',
        en: 'Catch - Counter $counter',
        fr: 'Prise - Compteur $counter',
        es: 'Captura - Contador $counter',
      );
}
